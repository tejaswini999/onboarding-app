        ...
        fetch(`http://localhost:4000/students/${studentId}`)
            ...
            .then(data => {
                this.setState({
                    ...
                    domicileDoc: data.domicileDoc,
                    birthDoc: data.birthDoc,
                    marksheetDoc: data.marksheetDoc,
                    policeClearanceDoc: data.policeClearanceDoc,
        ...
        return (
            <div >
                ...
                <div style={{ border: '1.5px darkblue', borderStyle: 'solid' }} className="home">
                    <p style={{ fontSize: '24px', fontFamily: 'sans-serif', color: 'darkblue' }}>Onboarding Form(Edit)</p>
                            ...
                            <tr>
                                ...
                                <td className="right">
                                    <div className="check">
                                        ...
                                        <input style={{ width: "15px" }} className="input" name="domicileDoc" type="checkbox" checked={this.state.domicileDoc} onChange={(e) => this.docChange(e)}></input>
                                    </div>

                                    <div className="check">
                                        <label style={{ width: "90%" }}>Birth Certificate<span style={{ color: 'darkblue', fontWeight: 'bold', padding: '1px', fontSize: '25px' }}>*</span></label>
                                        <input style={{ width: "15px" }} className="input" name="birthDoc" type="checkbox" checked={this.state.birthDoc} onChange={(e) => this.docChange(e)}></input>
                                    </div>

                                    <div className="check">
                                        <label style={{ width: "90%" }}>Marksheets<span style={{ color: 'darkblue', fontWeight: 'bold', padding: '1px', fontSize: '25px' }}>*</span></label>
                                        <input style={{ width: "15px" }} className="input" name="marksheetDoc" type="checkbox" checked={this.state.marksheetDoc} onChange={(e) => this.docChange(e)}></input>
                                    </div>
                                    ...
                                    <div className="check">
                                        ...
                                        <input style={{ width: "15px" }} className="input" name="policeClearanceDoc" type="checkbox" checked={this.state.policeClearanceDoc} onChange={(e) => this.docChange(e)}></input>
                                    </div>
                                    ...
                                    <div className="check">
                                        ...
                                        <input style={{ width: "15px" }} className="input" name="passportDoc" type="checkbox" checked={this.state.passportDoc} onChange={(e) => this.docChange(e)}></input>
                                    </div>

                                    <div className="check">
                                        <label style={{ width: "90%" }}>Declaration<span style={{ color: 'darkblue', fontWeight: 'bold', padding: '1px', fontSize: '25px' }}>*</span></label>
                                        <input style={{ width: "15px" }} className="input" name="declarationDoc" type="checkbox" checked={this.state.declarationDoc} onChange={(e) => this.docChange(e)}></input>
                                    </div>
